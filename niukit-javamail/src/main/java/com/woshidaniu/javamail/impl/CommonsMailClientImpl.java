 ...
 * 
 * *******************************************************************
 * @className	： CommonsMailClientImpl
 * @description	： Java邮件发送-commons-email实现
 * @author 		： <a href="mailto:hnxyhcwdl1003@163.com">kangzhidong</a>
 * @date		： 2017年4月14日 下午1:50:39
 * @version 	V1.0 
 * *******************************************************************
 */
public class CommonsMailClientImpl extends JavaMailClientAdapter {
	...
	protected void sendMail(EmailBody email,boolean isHtml) throws Exception{
		...
		// 设置邮件内容编码，防止乱码  
		mailSender.setCharset(email.getEncoding());
		// 设置邮件服务器主机名
		...
		//=============反垃圾邮件处理====================
		// 设置优先级(1:紧急 3:普通 5:低)
		mailSender.addHeader(HEADER_PRIORITY, email != null ? StringUtils.getSafeStr(email.getPriority(), "3") : "3");
