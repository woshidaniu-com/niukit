...
public class SearchMailTest {
	...
	public static Message[] search(Folder folder) throws Exception {
		...
		SearchTerm andTerm = new AndTerm(new FromStringTerm("智联招聘"),
				new BodyTerm("java工程师"));

		// 搜索发件人为”智联招聘“或主题包含”最新职位信息“的邮件
		SearchTerm orTerm = new OrTerm(new FromStringTerm("智联招聘"),
		...
		SearchTerm intComparisonTerm = new SizeTerm(IntegerComparisonTerm.GE,
				mailSize);
