...
import com.woshidaniu.javamail.impl.SpringMailClientImpl;
...
public class SpringMailClientTest {
	...
	public void setup(){
		...
		props.setProperty(JavaMailKey.MAIL_HOST, "202.118.40.3");
		props.setProperty(JavaMailKey.MAIL_PORT, "25");
		props.setProperty(JavaMailKey.MAIL_USER, "zfjw@cmu.edu.cn");
		props.setProperty(JavaMailKey.MAIL_PASSWORD, "yddgk983/*&*");
	...
	public void testDelete() throws Exception{
		...
		// 设置收件人的邮箱
		String sendTo = "540367164@qq.com";
