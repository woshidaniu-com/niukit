 ...
 * @version 2016年12月5日下午3:45:43
 */
public class NumberSelect extends TagSupport  implements QueryBody{

	private static final long serialVersionUID = 8527005580502403801L;

	private String name;
	private String text;
	private String format;
	private static final String template_name="selectNumber.ftl";
