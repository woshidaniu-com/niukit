package com.woshidaniu.web.servlet3.async;
...
/**
 * 
 * @className 	： AsyncContextQueueWriter
 * @description ： 向一个Queue<AsyncContext>中每个Context的Writer进行输出
 * @author 		： kangzhidong
 * @date 		： 2015-6-10 下午07:13:19
 */
