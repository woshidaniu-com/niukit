...
import com.woshidaniu.web.servlet.http.HttpServletCacheResponseWrapper;
...
public class HttpServletRequestCacheFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(ServletRequest request,
		...
		String r = servletContext.getRealPath("");
		...
		if (path == null) {
			path = servletContext.getRealPath(httpRequest.getRequestURI());
		}
		...
		String mt = servletContext.getMimeType(httpRequest.getRequestURI());
