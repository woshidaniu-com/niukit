package com.woshidaniu.web.core.config;
...
public class Ini implements Map<String, Ini.Section> {
     ...
     * @throws ServletFilterException if the text cannot be loaded
     */
    public void load(String iniConfig) throws ServletFilterException {
     ...
     * @throws ServletFilterException if unable
     */
    public void load(InputStream is) throws ServletFilterException {
        if (is == null) {
