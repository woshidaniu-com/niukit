...
/**
 * *******************************************************************
 * @className	： XHTMLImporterHandlerAdapter
 * @description	： TODO(描述这个类的作用)
 * @author 		： <a href="mailto:hnxyhcwdl1003@163.com">kangzhidong</a>
 * @date		： Dec 30, 2016 9:17:15 AM
 * @version 	V1.0 
 * *******************************************************************
 */
public abstract class XHTMLImporterHandlerAdapter implements XHTMLImporterHandler {

	@Override
	public void handle(WordprocessingMLPackage wmlPackage, File htmlFile,boolean fragment)
	...
	@Override
	public void handle(WordprocessingMLPackage wmlPackage, InputStream input,boolean fragment)
			throws IOException, Docx4JException {
		// TODO Auto-generated method stub
	...
	@Override
	public void handle(WordprocessingMLPackage wmlPackage, Document doc,boolean fragment)
			throws IOException, Docx4JException {
		// TODO Auto-generated method stub
