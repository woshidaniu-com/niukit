 ...
 * @see com.opensymphony.oscache.general.GeneralCacheAdministrator
 */
@SuppressWarnings("serial")
public class GeneralOSCacheAdministrator extends AbstractCacheAdministrator {
   
	private static transient final Logger LOG = LoggerFactory.getLogger(GeneralCacheAdministrator.class);
     ...
     */
    public GeneralOSCacheAdministrator() {
        this(null);
    }
     ...
     */
    public GeneralOSCacheAdministrator(Properties p) {
        super(p);
        LOG.info("Constructed GeneralOSCacheAdministrator()");
        createCache();
    }
