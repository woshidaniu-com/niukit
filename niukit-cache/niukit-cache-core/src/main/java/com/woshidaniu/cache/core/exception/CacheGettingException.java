...
public class CacheGettingException extends CacheException {
	/**
	 * 国际化信息key
	 */
	protected String msgKey = null;
	
	public CacheGettingException(String message) {
		super(message);
	}

	public CacheGettingException(Throwable cause) {
		super(cause);
	}

	public CacheGettingException(String message, Throwable cause) {
		super(message, cause);
	}

	public CacheGettingException(String message, Throwable cause, String... replaceParas) {
