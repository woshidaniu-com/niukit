...
import com.woshidaniu.safety.xss.http.HttpServletEscapedRichTextXSSRequestWrapper;
import com.woshidaniu.web.servlet.filter.AbstractPathMatchFilter;

public class HttpServletRequestEscapedRichTextXssFilter extends AbstractPathMatchFilter{
	...
	public void doFilterInternal(ServletRequest request,
		...
		if (this.antiSamyFactory.matches(httpRequest)) {
			...
			filterChain.doFilter(new HttpServletEscapedRichTextXSSRequestWrapper(antiSamyProxy, httpRequest), httpResponse);
		} else {
