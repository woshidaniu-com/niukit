...
public interface Scriptable {
     ...
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Context#getUndefinedValue
     */
     ...
     * @param start the object in which the lookup began
     * @return the value of the property (may be null), or NOT_FOUND
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Scriptable#get(String,Scriptable)
     */
     ...
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Scriptable#get(int, Scriptable)
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.ScriptableObject#putProperty(Scriptable, String, Object)
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @param start the object whose property is being set
     * @param value value to set the property to
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Scriptable#has(int, Scriptable)
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Scriptable#get(int, Scriptable)
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.Scriptable#get(int, Scriptable)
     * @see com.yahoo.platform.yui.compressor.org.mozilla.javascript.ScriptableObject#deleteProperty(Scriptable, int)
     */
