...
public class SecurityPasswordUtils {
	...
	public static void main(String[] args) throws InvalidKeyException, NoSuchAlgorithmException {
		...
		System.out.println(SecurityPasswordUtils.generateOTP((new Date().getTime() + "").getBytes(), 0, 6, false, -1));
		System.out.println(SecurityPasswordUtils.generateOTP((new Date().getTime() + "").getBytes(), 1, 6, false, -1));
		System.out.println(SecurityPasswordUtils.generateOTP((new Date().getTime() + "").getBytes(), 2, 6, false, -1));
		System.out.println(SecurityPasswordUtils.generateOTP((new Date().getTime() + "").getBytes(), 3, 6, false, -1));
		System.out.println(SecurityPasswordUtils.generateOTP((new Date().getTime() + "").getBytes(), 4, 6, false, -1));
		System.out.println(SecurityPasswordUtils.generateOTP((new Date().getTime() + "").getBytes(), 5, 6, false, -1));
	}
