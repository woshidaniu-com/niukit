 ...
 *@类描述：此算法暂时有问题
 *@创建人：kangzhidong
 *@创建时间：2014-10-9 上午11:37:40
 *@版本号:v1.0
 */
public class SMS4Codec {
	
	private static SMS4Codec instance = null;
	private SMS4Codec(){};
	public static SMS4Codec getInstance(){
		instance= (instance==null)?instance=new SMS4Codec():instance;
		return  instance;
	}
	...
	public static void main(String[] args) {
		...
		*/
		...
		byte[] in1 = { 0x01, 0x23, 0x45, 0x67, (byte) 0x89, (byte) 0xab,
				(byte) 0xcd, (byte) 0xef, (byte) 0xfe, (byte) 0xdc,
				(byte) 0xba, (byte) 0x98, 0x76, 0x54, 0x32, 0x10, 0x01, 0x23,
				0x45, 0x67, (byte) 0x89, (byte) 0xab, (byte) 0xcd, (byte) 0xef,
				(byte) 0xfe, (byte) 0xdc, (byte) 0xba, (byte) 0x98, 0x76, 0x54,
				0x32, 0x10 };
		...
		// 解密 128bit
		System.out.println();
		in = SMS4Codec.getInstance().decrypt(out, key);
