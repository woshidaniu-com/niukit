...
import com.woshidaniu.regexp.utils.RegexpPatternUtils;

/**
 * 
 *@类名称	: StringRegexpMatcher.java
 *@类描述	：使用正则表达式验证【普通字符串】或提取数据
 *@创建人	：kangzhidong
 *@创建时间	：Mar 23, 2016 4:33:03 PM
 *@修改人	：
 *@修改时间	：
 *@版本号	:v1.0
 */
public class StringRegexpMatcher implements com.woshidaniu.regexp.PatternMatcher {
