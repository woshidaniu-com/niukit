...
public class ProcessInstanceHighlightsResource {
  ...
  @Autowired
	...
	@RequestMapping(value="/processDiagram/instance/{processInstanceId}/highlights.zf", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	  ...
	  ObjectNode responseJSON = objectMapper.createObjectNode();
		...
		try {
			...
			if(processInstance == null){
				...
				processDefinitionId = singleResult.getProcessDefinitionId();
			}else{
			...
			if(processInstance != null){
				...
				//如果流程已经结束，那么高亮的Activity应该是历史库中的所有节点
