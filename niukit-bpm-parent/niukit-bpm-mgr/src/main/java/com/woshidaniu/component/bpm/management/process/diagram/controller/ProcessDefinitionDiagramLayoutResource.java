...
public class ProcessDefinitionDiagramLayoutResource extends BaseProcessDefinitionDiagramLayoutResource {
	...
	@RequestMapping(value = "/processDiagram/definition/{processDefinitionId}/diagram-layout.zf", 
			method = RequestMethod.GET, 
			produces = "application/json;charset=utf-8")
	@ResponseBody
	public Object getDiagram(@PathVariable String processDefinitionId) throws JsonProcessingException, IOException {
