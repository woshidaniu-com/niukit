...
public interface WorkflowDefinitionConversionListener {
   ...
   void beforeStepConversion(WorkflowDefinitionConversion conversion, StepDefinitionConverter stepConverter, StepDefinition step);
	
   void afterStepConversion(WorkflowDefinitionConversion conversion, StepDefinitionConverter stepConverter, StepDefinition step);
  /**
