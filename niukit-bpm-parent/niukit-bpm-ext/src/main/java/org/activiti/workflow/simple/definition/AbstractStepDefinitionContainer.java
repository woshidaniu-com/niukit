...
public abstract class AbstractStepDefinitionContainer<T> implements StepDefinitionContainer<T> {
  ...
  //custom human step
  public T addCustomHumanStep(String id, String name, String description, boolean backSupport, boolean interruptSupport){
	  createCustomHumanStepDefinition(id, name, description, backSupport, interruptSupport);
	  return (T)this;
  }
  
  public T addCustomHumanStep(CustomHumanStepDefinition customHumanStep){
	  addStep(customHumanStep);
	  return (T)this;
  }
  
  protected CustomHumanStepDefinition createCustomHumanStepDefinition(String id, String name, String description, boolean backSupport, boolean interruptSupport) {
		CustomHumanStepDefinition customHumanStepDefinition = new CustomHumanStepDefinition();
		customHumanStepDefinition.setId(id);
		customHumanStepDefinition.setName(name);
		customHumanStepDefinition.setDescription(description);
		customHumanStepDefinition.setBackSupport(backSupport);
		customHumanStepDefinition.setInterruptSupport(interruptSupport);
		addStep(customHumanStepDefinition);
		return customHumanStepDefinition;
	}
