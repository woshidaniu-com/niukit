...
/**
 * 
 * @className	： DatasourceMapperSQLInjector
 * @description	：SQL 自动注入器
 * @author 		： kangzhidong
 * @date		： Jan 26, 2016 2:23:10 PM
 * @version 	V1.0
 */
public class DatasourceMapperSQLInjector {

	protected static Logger LOG = LoggerFactory.getLogger(DatasourceMapperSQLInjector.class);

	private Configuration configuration;
	private MapperBuilderAssistant assistant;

	public DatasourceMapperSQLInjector(Configuration configuration) {
		super();
	...
	public void inject(Class<?> mapperClass) {
		...
		Class<?> modelClass = GenericsUtils.getSuperClassGenricType(mapperClass, AnnotationMapper.class);
