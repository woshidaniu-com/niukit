 ...
 * 
 * @className	： CpioUtils
 * @description	： Apache commons compress CPIO打包
 * @author 		： kangzhidong
 * @date		： Aug 10, 2015 4:49:44 PM
 */
public abstract class CpioUtils  extends CompressUtils{
	...
	public static void doCompress(File srcFile, File destFile) throws IOException {  
        ...
        try {  
            ...
            out = new CpioArchiveOutputStream(new BufferedOutputStream(new FileOutputStream(destFile), DEFAULT_BUFFER_SIZE));  
