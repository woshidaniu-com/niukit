...
import com.woshidaniu.beanutils.exception.PropertyGettingException;
import com.woshidaniu.beanutils.exception.PropertySettingException;


/**
 * 
 *@类名称:OgnlBeanUtils.java
 *@类描述：设置提取javabean的属性：
 *@创建人：kangzhidong
 *@创建时间：2015-3-31 上午11:19:51
 *@修改人：
 *@修改时间：
 *@版本号:v1.0
 */
...
public final class OgnlBeanUtils {
	 ...
	 */
	protected static Logger LOG = LoggerFactory.getLogger(OgnlBeanUtils.class);
	...
	public static Object[] getArrayProperty(Object bean, String expression){
		...
		Object value = OgnlBeanUtils.getProperty(bean, expression);
		if (value == null) {
			return (null);
	...
	public static void populate(Object bean, Map<String,Object> properties) {
		...
		while (names.hasNext()) {
			...
			OgnlBeanUtils.setProperty(bean, expression, value);
		}
	}
