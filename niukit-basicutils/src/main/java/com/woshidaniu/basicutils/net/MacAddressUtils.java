...
public class MacAddressUtils {
	 ...
	 * @modify description :
	 */
	public static final String getRemoteMacAddr(String remoteIPAddr) throws Exception {
	...
	/**
	 * 
	 *@描述：获取widnow7网卡的mac地址
	 *@创建人:kangzhidong
	 *@创建时间:2014-12-26下午02:29:45
	 *@修改人:
	 *@修改时间:
	 *@修改描述:
	 *@return
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(MacAddressUtils.getRemoteMacAddr("10.71.32.125"));
	}
