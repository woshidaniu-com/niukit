 ...
 *@类描述	：随机密码生成器
 *@创建人	：kangzhidong
 *@创建时间	：Mar 10, 2016 1:03:56 PM
 *@修改人	：
 *@修改时间	：
 *@版本号	:v1.0
 */
public abstract class RandomUtils extends org.apache.commons.lang.math.RandomUtils {
	  ...
	  */
	 public static String genLowerRandomStr(int pwd_len) {
		 int i; // 生成的随机数
	  ...
	  */
	 public static String genUpperRandomStr(int length) {
		 return genLowerRandomStr(length).toUpperCase();
	 }
	 ...
	 * @return 密码的字符串
	 */
	public static String genMixRandomStr(int pwd_len) {
		int i; // 生成的随机数
		int count = 0; // 生成的密码的长度
		StringBuffer pwd = new StringBuffer("");
		Random r = new Random();
	...
	public static void main(String[] args) {
		for (int i = 0; i < 1000; i++) {
			...
			System.out.println(RandomUtils.genRandomNum(6));
		}
