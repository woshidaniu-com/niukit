...
public abstract class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static String getSafeObj(Object str) {
		return (BlankUtils.isBlank(str) || !(str instanceof String)) ? null
				: str.toString();
	}

	public static String getSafeStr(Object str) {
		return (BlankUtils.isBlank(str) || !(str instanceof String)) ? "" : str
				.toString();
	}

	public static String getSafeStr(String str) {
		return BlankUtils.isBlank(str) ? "" : str;
	}

	public static String getSafeStr(Object str, String defaultStr) {
		return BlankUtils.isBlank(str) || BlankUtils.isBlank(str.toString()) ? defaultStr : str.toString();
	}

	public static int getSafeInt(String str, String defaultStr) {
		return Integer.parseInt(BlankUtils.isBlank(str) ? defaultStr : str);
	}

	public static float getSafeFloat(String str, String defaultStr) {
		return Float.parseFloat(BlankUtils.isBlank(str) ? defaultStr : str);
	}

	public static long getSafeLong(Object str, String defaultStr) {
		return Long.parseLong(BlankUtils.isBlank(str) ? defaultStr : str
				.toString());
	}

	public static boolean getSafeBoolean(Object str, String defaultStr) {
		return BooleanUtils.parse(BlankUtils.isBlank(str) ? defaultStr : str
				.toString());
	}
