...
/**
 *@类名称: ModuleResourceBundleTextProvider.java
 *@类描述：重写Struts2国际化资源读取对象，实现不同模块不同配置文件读取
 *@创建人：kangzhidong
 *@创建时间：Jan 29, 2016 9:46:49 AM
 *@修改人：
 *@修改时间：
 *@版本号:v1.0
 *@see com.opensymphony.xwork2.TextProviderSupport
 */
public class ModuleResourceBundleTextProvider implements ResourceBundleTextProvider {
     ...
     * Default constructor
     */
    public ModuleResourceBundleTextProvider() {
    }
     ...
     */
    public ModuleResourceBundleTextProvider(Class clazz, LocaleProvider provider) {
        this.clazz = clazz;
     ...
     * @param provider a locale provider.
     */
    public ModuleResourceBundleTextProvider(ResourceBundle bundle, LocaleProvider provider) {
        this.bundle = bundle;
        this.localeProvider = provider;
    }
