...
/**
 * @类名称 : FlywayWithoutClean.java
 * @类描述 ： 为了数据库数据安全，这里我们拷贝Flyway对象并移除默认的clean逻辑
 * @创建人 ：kangzhidong
 * @创建时间 ：2016年5月4日 下午4:21:46
 * @修改人 ：
 * @修改时间 ：
 * @版本号 :v1.0
 */
public class FlywayWithoutClean extends Flyway implements FlywayConfiguration {
	
    private static final Log LOG = LogFactory.getLog(FlywayWithoutClean.class);
