...
public class DBInfo {
	...
	static {
		...
		DB_DRIVER_MAP.put("sqlserver2000","com.microsoft.jdbc.sqlserver.SQLServerDriver");
		DB_DRIVER_MAP.put("sqlserver2005","com.microsoft.sqlserver.jdbc.SQLServerDriver");
		...
		DB_URL_MAP.put("sqlserver2000","jdbc:microsoft:sqlserver://{ip}:{port};DatabaseName={database}");
		DB_URL_MAP.put("sqlserver2005","jdbc:sqlserver://{ip}:{port};DatabaseName={database}");
		DB_URL_MAP.put("postgresql", "jdbc:postgresql://{ip}:{port}/{database}");
