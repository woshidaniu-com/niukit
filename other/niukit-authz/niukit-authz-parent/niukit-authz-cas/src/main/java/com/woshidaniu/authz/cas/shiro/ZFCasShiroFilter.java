...
import com.woshidaniu.authz.cas.filter.ZFCasFilter;
import com.woshidaniu.authz.cas.token.ZFCasToken;
import com.woshidaniu.web.utils.RemoteAddrUtils;

/**
 * 
 * @className	： ZFCasShiroFilter
 * @description	： cas shiro过滤器
 * @author 		：康康（1571）
 * @date		： 2018年5月3日 上午9:29:23
 * @version 	V1.0
 */
public class ZFCasShiroFilter extends AuthenticatingFilter{
