...
/**
 * 
 * @className	： ZFCasTicketValidationFilter
 * @description	： 
 * 		创建并代理jasig提供的一种TicketValidationFilter拦截器。。ShiroCasProperties用于初始化其被代理对象的FilterConfig
 * @author 		：康康（1571）
 * @date		： 2018年4月24日 上午10:54:41
 * @version 	V1.0
 */
public class ZFCasTicketValidationFilter extends AbstractShiroCasPropertiesNeedProxyFilter {
	
	@Override
	public void doInitDelegateAndConfig(ProxyFilterConfig proxyFilterConfig) throws ServletException {
