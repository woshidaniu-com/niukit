...
;(function($) {
	...
	Chosen = (function(_super) {
		...
		Chosen.prototype.results_show = function() {
			...
			var bootbox = this.container.closest('.bootbox');
			if ($(bootbox).size() > 0) {
				var modalBodyMaxHeight = parseInt(bootbox.find('.modal-body')
						.css('max-height'));
				var modalBodyHeight = parseInt(bootbox.find('.modal-body')
						.height());
				...
				var containerBootBottom = modalBodyHeight - containerBootTop;
		...
		Chosen.prototype.results_hide = function() {
			if (this.results_showing) {
				...
				this.container.removeClass('chosen-container-up');
				var modalBody = this.container.closest('.bootbox').find(
						'.modal-body');
