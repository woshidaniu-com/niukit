 ...
 */
package com.woshidaniu.web.captcha.image;
...
/**
 *@类名称 : CaptchaBufferedImage.java
 *@类描述 ：
 *@创建人 ：kangzhidong
 *@创建时间 ：Mar 10, 2016 10:49:02 AM
 *@修改人 ：
 *@修改时间 ：
 *@版本号 :v1.0
 */

public class CaptchaBufferedImage {
	...
	public CaptchaBufferedImage(int width, int height, String... createTypeFlag) {
		this.width = width;
		this.height = height;
