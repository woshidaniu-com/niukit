...
public class POIConfigUtils extends ConfigUtils {
	
	private static ThreadLocal<Properties> configCached = new ThreadLocal<Properties>();  
	public	static String DEFAULT_LOCATION = "fastpoi.properties";
	...
	public static Properties getConfig(String location) {
		if (configCached.get() == null) {
			configCached.set(ConfigUtils.getProperties(POIConfigUtils.class, location));
        }
