...
/**
 *@类名称	: FactoryFinder.java
 *@类描述	：
 *@创建人	：kangzhidong
 *@创建时间	：Mar 29, 2016 9:18:23 AM
 *@修改人	：
 *@修改时间	：
 *@版本号	:v1.0
 */
public class FactoryFinder {
	...
	protected static Logger LOG = LoggerFactory.getLogger(FactoryFinder.class);
	
	protected static final String DEFAULT_PACKAGE = "com.sun.xml.internal.";
